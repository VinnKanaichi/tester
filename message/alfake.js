...
global.fdoc = { key : { participant : '0@s.whatsapp.net'}, message: { documentMessage: { title: pushname, jpegThumbnail: fs.readFileSync('./stik/thumb.jpeg')}}}
